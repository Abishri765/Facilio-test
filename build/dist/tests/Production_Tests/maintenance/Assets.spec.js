...
export async function createAsset_maintenance(page, baseURL, testName) {
    page.setDefaultTimeout(30000);
    try {
        await page.reload();
        await page.waitForTimeout(3000);
        await page.waitForLoadState('networkidle');
        await page.locator('#sidebar-icon-43438').click();
        await page.waitForLoadState('networkidle');
    ...
    try {
        ...
        await page.getByRole('listitem').filter({ hasText: 'facilio' }).nth(2).click();
