...
export async function editWorkorder_tenantportal(page, baseURL, testName) {
  ...
  try {
    ...
    const text = "Request created successfully"; //expected text "Request updated successfully";
