...
export async function isStateFlowWorking_maintenance(page, baseURL, testName) {
  ...
  try {
    ...
    await page.waitForSelector(
      '//*[@id="q-app"]/div[1]/div[1]/div[2]/div/div[1]/main/div[1]/div/div[3]/div/div[1]'
    );
  ...
  try {
    ...
    await page
      .getByRole("listitem")
      .filter({ hasText: "Site1" })
      .nth(1)
      .click();
    await page.getByPlaceholder("Type your  Description").click();
    await page
      .getByPlaceholder("Type your  Description")
      .fill("for testing purpose");
    await page
    ...
    const element = page.locator(
      "div:nth-child(6) > .el-form-item > .el-form-item__content > .f-lookup-chooser > .el-select > .el-input > .el-input__inner"
    );
    await page
      .locator(
        "div:nth-child(6) > .el-form-item > .el-form-item__content > .f-lookup-chooser > .el-select > .el-input > .el-input__inner"
    ...
    const element2 = page
      .locator(
        ".form-one-column > .el-form-item > .el-form-item__content > .f-lookup-chooser > .el-select > .el-input > .el-input__inner"
      )
      .first();
    ...
    await page.locator("div").filter({ hasText: "Abcd" }).nth(2).click();
    await page.getByRole("button", { name: "Add Task" }).click();
    await page.getByPlaceholder("Enter a task").fill("DomoTask1");
    ...
    message = `${testName} - Stateflow - workorder created successfully`;
    console.log(message);
    await toPlaywrightReport(message);
  } catch (error) {
    console.log(error);
  ...
  try {
    ...
    await page.locator('div').filter({ hasText: '#1 DomoTask1' }).first().click();
    await page.waitForTimeout(2000);
    await page.locator(".width40px > .fa").click();
    await page.getByText("All tasks closed").click();
    let message = `${testName} - Stateflow - tasks visible`;
    console.log(message);
    await toPlaywrightReport(message);
  } catch (error) {
    console.log(error);
    const message = `${testName} - StateFlow[workorder] - Error: Tasks not working!!!`;
    console.log(message);
    await sendAlertMessage(message);
    await toPlaywrightReport(message);
    return -1;
  ...
  try {
    ...
    await page.waitForLoadState("networkidle");
    let message = `${testName} - Stateflow - StateFlow working normally`;
    console.log(message);
    await toPlaywrightReport(message);
  } catch (error) {
    console.log(error);
