...
export async function investa_loginWithPassword_tenants_identity(page, baseURL, username, password, testName) { //uses /identity/ instead of /auth/
    ...
    try{
        ...
        let message = 'Tenant portal - Authentication (identity auth) - Logged in successfully'
        console.log(message);
        await toPlaywrightReport(message);
    }
     catch (error) {
